...
class RandomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        elif self.data_generation == "constant" or self.data_generation == "alibaba" or self.data_generation.startswith('prod'):
...
def generate_random_data(
    ...
    for j in range(0, nbatches):
        ...
        elif data_generation == "constant" or data_generation == "alibaba" or data_generation.startswith('prod'):
